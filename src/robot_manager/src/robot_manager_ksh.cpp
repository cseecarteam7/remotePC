...
void feedMsgCallback(const std_msgs::String::ConstPtr& msg)
{
	...
	//feeding msg
		...
		printf("\n[robot_manager/feedMsgCallback] FEED CATS NOW!\n");
		feedFlag = 2;
	}
}
