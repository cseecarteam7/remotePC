...
def cat_detector():
	...
	rospy.init_node('cat_detector', anonymous = True)
	rate = rospy.Rate(10)
...
cat_cascade = cv2.CascadeClassifier('/home/sunny/catkin_ws/src/cat_detector/src/haarcascade_frontalcatface.xml')
cat_ext_cascade = cv2.CascadeClassifier('/home/sunny/catkin_ws/src/cat_detector/src/haarcascade_frontalcatface_extended.xml')
...
TEXTFILENAME = "/home/sunny/catkin_ws/src/cat_detector/src/detected_index.txt"
DETECTED_IMAGE_DIR = '/home/sunny/Desktop/detected_image/'
...
def processImage(image_dir,image_filename):
	...
	if isCat is True:
		...
		print('[cat_detector/precessImage] CAT DETECTED!\n')
...
while idx < 9990:
	# set file name
	if idx <= 9:
		filename = 'left000'+str(idx)+'.jpg'
	elif idx <= 99:
		filename = 'left00'+str(idx)+'.jpg'
	elif idx <= 999:
